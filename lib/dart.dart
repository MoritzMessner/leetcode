import 'package:dart/leet/80.dart';
...
void main() {
  ...
  // Solution80().removeDuplicates([1, 1, 1, 2, 2, 3]);
  // Solution80().removeDuplicates([1, 1, 1]);
  Solution80().removeDuplicates([
    -50,
    -50,
    -49,
    -48,
  ...
  // Solution80().removeDuplicates([0, 0, 0, 0]);
  // Solution80().removeDuplicates([0, 0, 1, 1, 1, 1, 2, 3, 3]);
}
